...
DEFAULT_KREPA_INITIAL_HEALTH=90
DEFAULT_KREPA_INITIAL_AFFECTION=60
DEFAULT_KREPA_INITIAL_FULLNESS=50
...
KREPA_INITIAL_HEALTH=${KREPA_INITIAL_HEALTH:-$DEFAULT_KREPA_INITIAL_HEALTH}
KREPA_INITIAL_AFFECTION=${KREPA_INITIAL_AFFECTION:-$DEFAULT_KREPA_INITIAL_AFFECTION}
KREPA_INITIAL_FULLNESS=${KREPA_INITIAL_FULLNESS:-$DEFAULT_KREPA_INITIAL_FULLNESS}
...
create_environment_file() {
    ...
    # Krepa values
    KREPA_INITIAL_HEALTH=$KREPA_INITIAL_HEALTH
    KREPA_INITIAL_AFFECTION=$KREPA_INITIAL_AFFECTION
    KREPA_INITIAL_FULLNESS=$KREPA_INITIAL_FULLNESS
